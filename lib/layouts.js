import { coverRatio } from "./poster.js";
...
function dimensions(width, type = "book") {
  if (width < 640) {
    ...
    return { columns, cell: width / columns, cover: type === "film" ? [102, 132] : type === "music" ? [88, 112] : [88, 118], row: type === "film" ? 172 : type === "music" ? 105 : 112 };
  }
  if (width < 1024) {
    const columns = type === "film" ? 4 : type === "music" ? 7 : 6;
    return { columns, cell: width / columns, cover: type === "film" ? [108, 148] : type === "music" ? [96, 132] : [92, 138], row: type === "film" ? 176 : type === "music" ? 125 : 140 };
  }
  const columns = type === "film" ? 5 : type === "music" ? 12 : 10;
  return { columns, cell: width / columns, cover: type === "film" ? [130, 178] : type === "music" ? [122, 154] : [110, 155], row: type === "film" ? 212 : type === "music" ? 130 : 158 };
}
